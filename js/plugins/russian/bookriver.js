...
var popularNovels = function (page, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    url = exports.site + "/genre?page=".concat(page, "&perPage=24&sortingType=");
                ...
                case 2:
                    ...
                    if (jsonRaw) {
                        ...
                        (_d = (_c = (_b = json.props.pageProps.state.pagesFilter) === null || _b === void 0 ? void 0 : _b.genre) === null || _c === void 0 ? void 0 : _c.books) === null || _d === void 0 ? void 0 : _d.forEach(function (novel) {
                            return novels.push({
                                name: novel.name,
...
var searchNovels = function (searchTerm) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    url = "https://api.bookriver.ru/api/v1/search/autocomplete?keyword=".concat(searchTerm, "&page=1&perPage=10");
                    return [4 /*yield*/, (0, fetch_1.fetchApi)(url)];
                case 1:
                    result = _c.sent();
                    return [4 /*yield*/, result.json()];
