            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    loadedCheerio("#bookListBlock > div > div").each(function () {
                        ...
                        var cover = (_b = loadedCheerio(this).find("div > a > img").attr("src")) === null || _b === void 0 ? void 0 : _b.trim();
                ...
                case 2:
                    ...
                    novel = {
                        ...
                        genres: loadedCheerio(".genre-list > a")
                            .map(function (index, element) { return loadedCheerio(element).text(); }).get().join(","),
                    };
                    chapters = [];
...
var searchNovels = function (searchTerm) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(exports.site, "/search?query=").concat(searchTerm, "&type=all");
                    return [4 /*yield*/, (0, fetch_1.fetchApi)(url)];
                case 1:
                    result = _a.sent();
                    return [4 /*yield*/, result.text()];
