...
function popularNovels(page, { showLatestNovels, filters }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        url += (filters === null || filters === void 0 ? void 0 : filters.order) ? (_a = filters === null || filters === void 0 ? void 0 : filters.order) === null || _a === void 0 ? void 0 : _a.replace("+", "") : "-";
        ...
        if ((_c = filters === null || filters === void 0 ? void 0 : filters.statuss) === null || _c === void 0 ? void 0 : _c.length) {
            url += filters === null || filters === void 0 ? void 0 : filters.statuss.map((i) => `&status=${i}`).join("");
        }
        if ((_d = filters === null || filters === void 0 ? void 0 : filters.genres) === null || _d === void 0 ? void 0 : _d.length) {
            url += filters.genres.map((i) => `&genres=${i}`).join("");
        }
        if ((_e = filters === null || filters === void 0 ? void 0 : filters.categories) === null || _e === void 0 ? void 0 : _e.length) {
...
function parseNovelAndChapters(novelUrl) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield fetchApi(baseUrl + "/api/titles/" + novelID);
        let body = yield result.json();
        let novel = {
            url: novelUrl,
            ...
            cover: baseUrl +
                (((_a = body.content.img) === null || _a === void 0 ? void 0 : _a.high) || ((_b = body.content.img) === null || _b === void 0 ? void 0 : _b.mid) || body.content.img.low),
        ...
        let chapters = [];
        for (let i = 0; i < all; i++) {
            let chapterResult = yield fetchApi(baseUrl +
