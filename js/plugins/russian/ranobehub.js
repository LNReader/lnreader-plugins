...
function popularNovels(page, { showLatestNovels, filters }) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        url += showLatestNovels ? "last_chapter_at" : (filters === null || filters === void 0 ? void 0 : filters.sort) || "computed_rating";
        url += "&status=" + ((filters === null || filters === void 0 ? void 0 : filters.status) ? filters === null || filters === void 0 ? void 0 : filters.status : "0");
        if ((_a = filters === null || filters === void 0 ? void 0 : filters.country) === null || _a === void 0 ? void 0 : _a.length) {
            url += "&country=" + (filters === null || filters === void 0 ? void 0 : filters.country.join(","));
        }
        let tags = [].concat(filters === null || filters === void 0 ? void 0 : filters.tags, filters === null || filters === void 0 ? void 0 : filters.events).filter((t) => t);
...
function parseNovelAndChapters(novelUrl) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const novelId = novelUrl
            ...
            .split("-")[0];
        const result = yield fetchApi(`${baseUrl}api/ranobe/${novelId}`);
        ...
        const chaptersRaw = yield fetchApi(fetchChaptersUrl);
