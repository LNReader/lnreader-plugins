            ...
            switch (_b.label) {
                case 0:
                    ...
                    if ((filters === null || filters === void 0 ? void 0 : filters.genre) instanceof Array) {
                        url += filters.genre.map(function (genre, idx) { return "&genre[".concat(idx, "]=").concat(genre); }).join("");
                    }
                    if ((filters === null || filters === void 0 ? void 0 : filters.delgenre) instanceof Array) {
                        url += filters.delgenre.map(function (genre, idx) { return "&delgenre[".concat(idx, "]=del ").concat(genre); }).join("");
                    }
...
var searchNovels = function (searchTerm) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(exports.site, "/?searchrn=").concat(searchTerm, "&but=\u041F\u043E\u0438\u0441\u043A \u043F\u043E \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u044E&sortby=upd");
                    return [4 /*yield*/, (0, fetch_1.fetchApi)(url)];
                case 1:
                    result = _a.sent();
                    return [4 /*yield*/, result.text()];
