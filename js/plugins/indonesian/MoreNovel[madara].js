...
exports.id = "morenovel";
exports.name = "MoreNovel [madara]";
exports.icon = "multisrc/madara/icons/morenovel.png";
exports.version = "1.0.0";
exports.site = "https://morenovel.net/";
var baseUrl = exports.site;
var popularNovels = function (pageNo, _a) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, fetch_1.fetchApi)(baseUrl + 'wp-admin/admin-ajax.php', {
                        method: 'POST',
            ...
            case 2:
                html = _a.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, (0, fetch_1.fetchApi)(baseUrl + 'ajax/chapters/', { method: 'POST' })
                    .then(function (res) { return res.text(); })];
            case 4:
                html = _a.sent();
                _a.label = 5;
...
var parseChapter = function (chapterUrl) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                url = baseUrl + "/" + "novel" + "/" + chapterUrl;
                return [4 /*yield*/, (0, fetch_1.fetchApi)(chapterUrl).then(function (res) { return res.text(); })];
            case 1:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
...
var searchNovels = function (searchTerm) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                novels = [];
                url = baseUrl + "?s=" + searchTerm + "&post_type=wp-manga";
                return [4 /*yield*/, (0, fetch_1.fetchApi)(url).then(function (res) { return res.text(); })];
            case 1:
                body = _a.sent();
                loadedCheerio = (0, cheerio_1.load)(body);
