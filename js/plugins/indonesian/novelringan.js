...
var coverUriPrefix = "https://i0.wp.com/novelringan.com/wp-content/uploads/";
var popularNovels = function (page) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(baseUrl, "/top-novel/page/").concat(page);
                ...
                case 2:
                    ...
                    loadedCheerio("article.post").each(function () {
                        var _a;
                        var novelName = (_a = loadedCheerio(this)
                            .find(".entry-title")
                            .text()) === null || _a === void 0 ? void 0 : _a.trim();
                        var novelCover = coverUriPrefix + loadedCheerio(this).find("img").attr("data-sxrx");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    novels = [];
                    loadedCheerio("article.post").each(function () {
                        var novelName = loadedCheerio(this).find(".entry-title").text();
                        var novelCover = coverUriPrefix + loadedCheerio(this).find("img").attr("data-sxrx");
                        var novelUrl = loadedCheerio(this).find("h2 > a").attr("href");
                        if (!novelUrl)
                            return;
