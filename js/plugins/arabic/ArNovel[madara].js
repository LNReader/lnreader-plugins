...
const popularNovels = (pageNo, { filters, showLatestNovels }) => __awaiter(void 0, void 0, void 0, function* () {
    const novels = [];
    let url = exports.site + ((filters === null || filters === void 0 ? void 0 : filters.genres) ? "home/" + filters.genres + '/' : "novel/");
    url += '/page/' + pageNo + '/' +
