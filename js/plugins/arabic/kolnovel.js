...
var parseNovelAndChapters = function parseNovelAndChapters(novelUrl) {
    return __awaiter(this, void 0, void 0, function () {
...
var parseChapter = function parseChapter(chapterUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var result, body, loadedCheerio, ignore, chapterText;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    body = _a.sent();
                    loadedCheerio = (0, cheerio_1.load)(body);
                    ignore = loadedCheerio(".epcontent > p").next().attr("class");
                    loadedCheerio("p.".concat(ignore)).remove();
...
var searchNovels = function searchNovels(searchTerm) {
    return __awaiter(this, void 0, void 0, function () {
