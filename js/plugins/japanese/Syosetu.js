...
var searchUrl = function (pagenum, order) {
...
var popularNovels = function (pageNo) {
    return __awaiter(this, void 0, void 0, function () {
        function getNovelsFromPage(pagenumber) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, fetch_1.fetchApi)(searchUrl(pagenumber))];
                        case 1:
                            result = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getNovelsFromPage(pageNo)];
                case 1:
                    novels = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [3 /*break*/, 6];
                case 3: return [4 /*yield*/, (0, fetch_1.fetchApi)(searchUrl() + "&word=".concat(novel.name))];
                case 4:
                    nameResult = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        function getNovelsFromPage(pagenumber) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, fetch_1.fetchApi)(searchUrl(pagenumber) + "&word=".concat(searchTerm))];
                        case 1:
                            result = _a.sent();
                            return [4 /*yield*/, result.text()];
                        case 2:
