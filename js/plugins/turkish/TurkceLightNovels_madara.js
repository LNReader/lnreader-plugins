...
exports.id = "sturkcelightnovels.com";
exports.name = "TurkceLightNovels_madara";
exports.icon = "icon/multisrc/madara/icons/turkcelightnovels.png";
...
const popularNovels = (pageNo, { showLatestNovels }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const sortOrder = showLatestNovels
        ? '?m_orderby=latest'
        : '/?m_orderby=rating';
    let url = exports.site + "light-novel" + '/page/' + pageNo + sortOrder;
