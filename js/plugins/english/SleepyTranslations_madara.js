...
exports.id = "ssleepytranslations.com";
exports.name = "SleepyTranslations_madara";
exports.icon = "icon/multisrc/madara/icons/sleepytranslations.png";
...
const popularNovels = (pageNo, { showLatestNovels }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const sortOrder = showLatestNovels
        ? '?m_orderby=latest'
        : '/?m_orderby=rating';
    let url = exports.site + "series" + '/page/' + pageNo + sortOrder;
