...
var popularNovels = function (page) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = baseUrl + "completed-novel/" + page;
                ...
                case 2:
                    ...
                    loadedCheerio(".li-row").each(function () {
                        var novelName = loadedCheerio(this).find(".tit").text();
                        var novelCover = loadedCheerio(this).find("img").attr("src");
                        var novelUrl = "https://freewebnovel.com" +
...
var parseNovelAndChapters = function (novelUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var url, result, body, loadedCheerio, novel, novelSummary, novelChapters, latestChapter, prefixUrl, i, chapterName, releaseDate, chapterUrl, chapter;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = novelUrl;
                ...
                case 2:
                    ...
                    novel.status = loadedCheerio("[title=Status]")
                        ...
                        .text()
                        .replace(/[\t\n]/g, "");
                    novelSummary = loadedCheerio(".inner").text().trim();
                    ...
                    prefixUrl = novelUrl.replace(".html", "/");
                    for (i = 1; i <= parseInt(latestChapter || "0", 10); i++) {
                        chapterName = "Chapter " + i;
                        releaseDate = null;
                        chapterUrl = "chapter-" + i;
                        chapterUrl = "".concat(prefixUrl).concat(chapterUrl, ".html");
                        chapter = {
                            name: chapterName,
...
var searchNovels = function (searchTerm) {
    return __awaiter(this, void 0, void 0, function () {
        var url, formData, result, body, loadedCheerio, novels;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = baseUrl + "search/";
