...
var popularNovels = function (page) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(baseUrl, "all-").concat(page, ".html");
                ...
                case 1:
                    ...
                    loadedCheerio("#article_list_content > li").each(function () {
                        ...
                        var novelUrl = baseUrl + ((_a = loadedCheerio(this).find("a").attr("href")) === null || _a === void 0 ? void 0 : _a.slice(1));
                        var novel = {
                            name: novelName,
                            cover: novelCover,
                            url: novelUrl,
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    loadedCheerio("ul.chapterlist > li").each(function () {
                        ...
                        var chapterUrl = baseUrl + ((_a = loadedCheerio(this).find("a").attr("href")) === null || _a === void 0 ? void 0 : _a.slice(1));
                        chapter.push({
                            name: chapterName,
...
var searchNovels = function (searchTerm) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(baseUrl, "index.php?s=so&module=book&keyword=").concat(searchTerm);
                    return [4 /*yield*/, (0, fetch_1.fetchApi)(url).then(function (r) { return r.text(); })];
                case 1:
                    body = _a.sent();
                    loadedCheerio = (0, cheerio_1.load)(body);
