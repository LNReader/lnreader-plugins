                ...
                case 2:
                    ...
                    loadedCheerio(".col-truyen-main .list-truyen .row").each(function () {
                        ...
                        var novelName = loadedCheerio(this)
                            ...
                            .text();
                        var novelCover = baseUrl + ((_a = loadedCheerio(this).find("img").attr("src")) === null || _a === void 0 ? void 0 : _a.slice(1));
...
var searchNovels = function (searchTerm) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    searchUrl = "".concat(baseUrl, "search?keyword=").concat(searchTerm);
