...
var popularNovels = function (page) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(baseUrl, "browse/all/popular/all/").concat(page);
...
var parseNovelAndChapters = function (novelUrl) {
    ...
    return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, (0, fetch_1.fetchApi)(chaptersUrl, { headers: headers }, pluginId).then(function (r) { return r.text(); })];
                        case 2:
        ...
        var url, body, loadedCheerio, novel, delay, lastPage, _b;
...
var searchNovels = function (searchTerm) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(baseUrl, "lnsearchlive");
                    link = "".concat(baseUrl, "search");
                    return [4 /*yield*/, (0, fetch_1.fetchApi)(link, {}, pluginId).then(function (r) { return r.text(); })];
                case 1:
                    response = _a.sent();
                    ...
                    return [4 /*yield*/, (0, fetch_1.fetchApi)(url, {
                            ...
                            body: formData,
                        }, pluginId).then(function (r) { return r.text(); })];
                case 2:
                    body = _a.sent();
                    loadedCheerio = (0, cheerio_1.load)(body);
                    novels = [];
                    ...
                    loadedCheerio(".novel-item").each(function () {
                        ...
                        var novelUrl = baseUrl + ((_a = loadedCheerio(this).find("a").attr("href")) === null || _a === void 0 ? void 0 : _a.substring(1));
                        novels.push({
                            name: novelName,
                            url: novelUrl,
                            cover: novelCover,
...
var fetchImage = function (url) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, fetch_1.fetchFile)(url, { headers: headers })];
