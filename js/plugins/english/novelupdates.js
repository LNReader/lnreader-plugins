...
function getPopularNovelsUrl(page, { showLatestNovels, filters }) {
    ...
    if ((_a = filters === null || filters === void 0 ? void 0 : filters.novelType) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    if ((_c = filters === null || filters === void 0 ? void 0 : filters.language) === null || _c === void 0 ? void 0 : _c.length) {
        url += '&org=' + (filters === null || filters === void 0 ? void 0 : filters.language.join(','));
    }
    if (filters === null || filters === void 0 ? void 0 : filters.storyStatus) {
...
function popularNovels(page, { showLatestNovels, filters }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield fetchApi(url, { headers: headers }, pluginId);
...
function parseNovelAndChapters(novelUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const text = yield fetchApi(link, {
            method: 'POST',
            body: formData,
            headers: headers,
        }, pluginId).then(data => data.text());
        ...
        loadedCheerio('li.sp_li_chp').each(function () {
            ...
            const chapterUrl = 'https:' + loadedCheerio(this).find('a').first().next().attr('href');
            chapter.push({
                name: chapterName,
...
function parseChapter(chapterUrl) {
    return __awaiter(this, void 0, void 0, function* () {
         ...
         */
        let isWordPress = loadedCheerio('meta[name="generator"]').attr('content') ||
        ...
        if (chapterText) {
             ...
             */
            chapterText = chapterText.replace(/href="\//g, `href="${getLocation(result.chapterUrl)}/`);
        }
        return chapterText;
    });
}
function searchNovels(searchTerm) {
    return __awaiter(this, void 0, void 0, function* () {
        const url = 'https://www.novelupdates.com/?s=' + searchTerm + '&post_type=seriesplans';
        const result = yield fetchApi(url, { headers: headers }, pluginId);
        const body = yield result.text();
        const loadedCheerio = cheerio.load(body);
        let novels = [];
