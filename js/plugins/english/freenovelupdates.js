...
var popularNovels = function (page) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = "".concat(baseUrl, "genres/light-novel-1002");
                ...
                case 1:
                    ...
                    loadedCheerio(".books-item").each(function () {
                        ...
                        if (novelUrl) {
                            var novelName = loadedCheerio(this).find(".title").text().trim();
...
var parseNovelAndChapters = function (novelUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var url, body, loadedCheerio, novel, novelCover;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = novelUrl;
                ...
                case 1:
                    ...
                    novelCover = loadedCheerio(".img > img").attr("src");
