...
exports.id = "sdaonovel.com";
exports.name = "DaoNovel_madara";
exports.icon = "icon/multisrc/madara/icons/daonovel.png";
...
const popularNovels = (pageNo, { showLatestNovels }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const sortOrder = showLatestNovels
        ? '?m_orderby=latest'
        : '/?m_orderby=rating';
    let url = exports.site + "novels-list" + '/page/' + pageNo + sortOrder;
