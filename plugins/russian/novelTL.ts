...
export const popularNovels: Plugin.popularNovels = async (page, { filters }) => { 
    const result = await fetchApi(baseUrl + "/api/site/v2/graphql", {
        method: "post",
        headers: {
                ...
                volume.chapters.forEach(
                    (chapter: any) =>
                        ...
                        novelChapters.push({
                            ...
                            releaseTime: dayjs(chapter.publishDate).format(
                                "LLL"
                            ),
                        })
                )
