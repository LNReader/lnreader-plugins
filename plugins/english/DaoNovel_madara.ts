...
export const id = "sdaonovel.com";
export const name = "DaoNovel_madara";
export const icon = "icon/multisrc/madara/icons/daonovel.png";
...
export const popularNovels: Plugin.popularNovels = async (pageNo, {showLatestNovels}) => {
    ...
    let url = site + "novels-list" + '/page/' + pageNo + sortOrder;
