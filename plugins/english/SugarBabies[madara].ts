...
const plugin = new MadaraPlugin({"id":"sugarbbscan","sourceSite":"https://sugarbbscan.com/","sourceName":"Sugar Babies","filters":{},"options":{"path":{"novels":"series","novel":"series","chapter":"series"},"lang":"English"}});
