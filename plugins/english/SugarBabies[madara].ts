...
export const id = "sugarbbscan";
export const name = "Sugar Babies [madara]";
export const icon = "multisrc/madara/icons/sugarbabies.png";
export const version = "1.0.0";
export const site = "https://sugarbbscan.com/";
const baseUrl = site;
