...
export const id = "lnheaven";
export const name = "LightNovelHeaven [madara]";
export const icon = "multisrc/madara/icons/lightnovelheaven.png";
export const version = "1.0.0";
export const site = "https://lightnovelheaven.com/";
const baseUrl = site;
