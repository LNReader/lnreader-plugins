...
export const id = "zetroTL";
export const name = "Zetro Translation [madara]";
export const icon = "multisrc/madara/icons/zetrotranslation.png";
export const version = "1.0.0";
export const site = "https://zetrotranslation.com/";
const baseUrl = site;

export const popularNovels: Plugin.popularNovels = async (pageNo, {filters, showLatestNovels}) => {
    const novels: Novel.Item[] = [];

    let url = site + (filters?.genres ? "genre/" + filters.genres + '/' : "novel/");
