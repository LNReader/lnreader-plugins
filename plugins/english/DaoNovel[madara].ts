...
export const id = "daonovel";
export const name = "DaoNovel [madara]";
export const icon = "multisrc/madara/icons/daonovel.png";
export const version = "1.0.0";
export const site = "https://daonovel.com/";
const baseUrl = site;

export const popularNovels: Plugin.popularNovels = async (pageNo, {filters, showLatestNovels}) => {
    const novels: Novel.Item[] = [];

    let url = site + (filters?.genres ? "novel-genre/" + filters.genres + '/' : "novels-list/");
