...
export const id = "guavaread";
export const name = "Guavaread [madara]";
export const icon = "multisrc/madara/icons/guavaread.png";
export const version = "1.0.0";
export const site = "https://guavaread.com/";
const baseUrl = site;
