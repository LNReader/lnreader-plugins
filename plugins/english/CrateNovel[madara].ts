...
const plugin = new MadaraPlugin({"id":"cratenovel","sourceSite":"https://cratenovel.com/","sourceName":"CrateNovel","filters":{},"options":{"useNewChapterEndpoint":true,"lang":"English"}});
