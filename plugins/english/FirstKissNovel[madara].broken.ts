...
export const id = "1stkissnovel";
export const name = "FirstKissNovel [madara]";
export const icon = "multisrc/madara/icons/firstkissnovel.png";
export const version = "1.0.0";
export const site = "https://1stkissnovel.org/";
const baseUrl = site;
