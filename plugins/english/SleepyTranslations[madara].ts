...
export const id = "sleeptTLS";
export const name = "SleepyTranslations [madara]";
export const icon = "multisrc/madara/icons/sleepytranslations.png";
export const version = "1.0.0";
export const site = "https://sleepytranslations.com/";
const baseUrl = site;

export const popularNovels: Plugin.popularNovels = async (pageNo, {filters, showLatestNovels}) => {
    const novels: Novel.Item[] = [];

    let url = site + (filters?.genres ? "novel-genre/" : "series/");
