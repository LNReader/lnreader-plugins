...
const plugin = new MadaraPlugin({"id":"novelroom","sourceSite":"https://novelroom.net/","sourceName":"Novelroom.net","filters":{},"options":{"path":{"novels":"manga","novel":"manga","chapter":"manga"},"lang":"English"}});
