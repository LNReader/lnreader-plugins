...
export const id = "boxnovel";
export const name = "BoxNovel [madara]";
...
export const popularNovels: Plugin.popularNovels = async (pageNo, {filters, showLatestNovels}) => {
    ...
    let url = site + (filters?.genres ? "manga-genre/" + filters.genres + '/' : "novel/");
