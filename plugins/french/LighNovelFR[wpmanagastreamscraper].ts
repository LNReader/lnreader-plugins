...
export const id = "lightnovelfr.com";
export const name = "Ligh Novel FR";
export const site = "https://lightnovelfr.com/";
export const version = "1.0.0";
export const icon = "src/Ligh Novel FR/ligh novel fr.png";
const pluginId = id;
