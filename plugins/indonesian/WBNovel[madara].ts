...
export const id = "wbnovel";
export const name = "WBNovel [madara]";
export const icon = "multisrc/madara/icons/wbnovel.png";
export const version = "1.0.0";
export const site = "https://wbnovel.com/";
const baseUrl = site;
