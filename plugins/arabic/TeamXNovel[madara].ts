...
const plugin = new MadaraPlugin({"id":"teamxnovel","sourceSite":"https://teamxnovel.com/","sourceName":"TeamXNovel","filters":[],"options":{"useNewChapterEndpoint":true,"lang":"Arabic"}});
