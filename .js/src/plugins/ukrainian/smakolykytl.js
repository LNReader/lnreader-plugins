...
var Smakolykytl = /** @class */ (function () {
    ...
    Smakolykytl.prototype.popularNovels = function (pageNo_1, _a) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(this.apiSite + sort)];
                    case 1:
                        result = _d.sent();
    ...
    Smakolykytl.prototype.parseNovel = function (novelPath) {
            ...
            return __generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(this.apiSite + '/projects/' + id)];
                    case 1:
                        result = _k.sent();
                        return [4 /*yield*/, result.json()];
                    case 2:
                        ...
                        chapters = [];
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(this.apiSite + '/projects/' + id + '/books')];
                    case 3:
                        res = _k.sent();
                    ...
                    case 4:
                        ...
                        (_j = data === null || data === void 0 ? void 0 : data.books) === null || _j === void 0 ? void 0 : _j.forEach(function (volume) {
                            var _a;
                            return (_a = volume === null || volume === void 0 ? void 0 : volume.chapters) === null || _a === void 0 ? void 0 : _a.forEach(function (chapter) {
    ...
    Smakolykytl.prototype.parseChapter = function (chapterPath) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(this.apiSite + '/chapters/' + id)];
                    case 1:
                        result = _b.sent();
                        return [4 /*yield*/, result.json()];
                    case 2:
    ...
    Smakolykytl.prototype.searchNovels = function (searchTerm) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, (0, fetch_1.fetchApi)(this.apiSite + '/projects')];
                    case 1:
                        result = _c.sent();
                        return [4 /*yield*/, result.json()];
                    case 2:
                        ...
                        novels = [];
                        (_b = (_a = json === null || json === void 0 ? void 0 : json.projects) === null || _a === void 0 ? void 0 : _a.filter(function (_a) {
                            var title = _a.title, id = _a.id;
                            return title.toLowerCase().includes(searchTitle) || String(id) == searchTerm;
