...
var StellarRealm = /** @class */ (function () {
    function StellarRealm() {
        var _this = this;
        this.id = 'stellar-realm';
        this.name = 'Stellar Realm';
        this.icon = '';
        this.site = 'https://stellarrealm.net';
        this.version = '1.0.0';
        this.filters = {
            tags: {
                label: 'Tags',
                ...
                options: TAGS.map(function (x) { return ({
                    label: x.name,
                    value: x.slug,
                }); }),
            },
            genres: {
                ...
                value: [],
                type: filterInputs_1.FilterTypes.CheckboxGroup,
                options: GENRES.map(function (x) { return ({
                    label: x.name,
                    value: x.slug,
                }); }),
            },
    ...
    StellarRealm.prototype.ensureCoverImage = function (url) {
        return (0, isAbsoluteUrl_1.isUrlAbsolute)(url) ? url : this.site + url;
    };
    StellarRealm.prototype.popularNovels = function (pageNo_1, _a) {
        return __awaiter(this, arguments, void 0, function (pageNo, _b, isRetry) {
            var query, tagsFilter, genresFilter, series, novels, error_1;
            var _this = this;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, fetch_1.fetchApi)("".concat(this.site, "/series?").concat(query.toString()), this.apiRequestInit)];
                    case 1: return [4 /*yield*/, (_c.sent()).json()];
                    case 2:
                        series = (_c.sent()).props.seriesList.data;
                        novels = series.map(function (x) { return ({
                            name: x.title,
                            path: x.slug,
                            cover: !!x.cover ? _this.ensureCoverImage(x.cover.url) : defaultCover_1.defaultCover,
                        }); });
                    ...
                    case 3:
                        ...
                        if (isRetry)
                            throw error_1;
                        return [2 /*return*/, this.popularNovels(pageNo, {
                                filters: filters,
    ...
    StellarRealm.prototype.parseNovel = function (novelPath_1) {
        return __awaiter(this, arguments, void 0, function (novelPath, isRetry) {
            var series, novel, chapters, error_2;
            if (isRetry === void 0) { isRetry = false; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        return [4 /*yield*/, (0, fetch_1.fetchApi)("".concat(this.site, "/series/").concat(novelPath), this.apiRequestInit)];
                    case 1: return [4 /*yield*/, (_a.sent()).json()];
                    case 2:
                        series = (_a.sent()).props.series;
                        novel = {
                            path: novelPath,
                            name: series.title,
                            cover: !!series.cover
                            ...
                            genres: __spreadArray(__spreadArray([], series.genres.map(function (x) { return x.name; }), true), [
                                series.tags.map(function (x) { return x.name; }),
                            ], false).join(','),
                        };
                        return [4 /*yield*/, (0, fetch_1.fetchApi)("".concat(this.site, "/series/").concat(novelPath, "/chapters"), this.apiRequestInit)];
                    case 3: return [4 /*yield*/, (_a.sent()).json()];
                    case 4:
                        chapters = (_a.sent()).chapters;
                        novel.chapters = chapters
                            .map(function (chapter) { return ({
                            name: chapter.name,
                            path: "".concat(novelPath, "/").concat(chapter.slug),
                    ...
                    case 5:
                        ...
                        if (isRetry)
                            throw error_2;
                        return [2 /*return*/, this.parseNovel(novelPath, true)];
                    case 6: return [2 /*return*/];
                }
            });
        });
    };
    StellarRealm.prototype.parseChapter = function (chapterPath_1) {
        return __awaiter(this, arguments, void 0, function (chapterPath, isRetry) {
            var chapter, error_3;
            if (isRetry === void 0) { isRetry = false; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, fetch_1.fetchApi)("".concat(this.site, "/series/").concat(chapterPath), this.apiRequestInit)];
                    case 1: return [4 /*yield*/, (_a.sent()).json()];
                    case 2:
                        chapter = (_a.sent()).props.chapter;
                        return [2 /*return*/, chapter.content];
                    case 3:
                        error_3 = _a.sent();
                        if (isRetry)
                            throw error_3;
                        return [2 /*return*/, this.parseChapter(chapterPath, true)];
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    StellarRealm.prototype.searchNovels = function (searchTerm_1, pageNo_1) {
        return __awaiter(this, arguments, void 0, function (searchTerm, pageNo, isRetry) {
            var searchResponse, searchResults, novels, error_4;
            var _this = this;
            if (isRetry === void 0) { isRetry = false; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, (0, fetch_1.fetchApi)("".concat(this.site, "/api/search?query=").concat(searchTerm))];
                    case 2:
                        searchResponse = _a.sent();
                        return [4 /*yield*/, searchResponse.json()];
                    case 3:
                        searchResults = _a.sent();
                        novels = searchResults.data.series.map(function (serie) { return ({
                            name: serie.title,
                            path: serie.slug,
                            cover: _this.ensureCoverImage(serie.cover.url),
                        }); });
                        return [2 /*return*/, novels];
                    case 4:
                        error_4 = _a.sent();
                        if (isRetry)
                            throw error_4;
                        return [2 /*return*/, this.searchNovels(searchTerm, pageNo, true)];
...
exports.default = new StellarRealm();
