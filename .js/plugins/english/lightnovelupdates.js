...
var LightNovelUpdates = /** @class */ (function () {
    function LightNovelUpdates() {
        this.id = "LightNovelUpdates";
        this.name = "Light Novel Updates";
        this.version = "1.0.0";
        this.icon = "src/en/lightnovelupdates/icon.png";
        this.site = "https://www.lightnovelupdates.com/";
        this.baseUrl = this.site;
    }
    LightNovelUpdates.prototype.popularNovels = function (pageNo, options) {
        return __awaiter(this, void 0, void 0, function () {
            var url, body, loadedCheerio, novels;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = "".concat(this.baseUrl, "novel/page/").concat(pageNo, "/?m_orderby=rating");
    ...
    LightNovelUpdates.prototype.parseNovelAndChapters = function (novelUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var url, body, loadedCheerio, novel, chapter, novelId, formData, data, text;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = novelUrl;
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, fetch_1.fetchApi)("https://www.lightnovelupdates.com/wp-admin/admin-ajax.php", {
                                method: "POST",
                                body: formData,
                            })];
                    case 2:
    ...
    LightNovelUpdates.prototype.parseChapter = function (chapterUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var chapterText;
            return __generator(this, function (_a) {
                chapterText = 'unable to load';
                return [2 /*return*/, chapterText];
            });
        });
    };
    LightNovelUpdates.prototype.searchNovels = function (searchTerm, pageNo) {
        return __awaiter(this, void 0, void 0, function () {
            var url, body, loadedCheerio, novels;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = "".concat(this.baseUrl, "?s=").concat(searchTerm, "&post_type=wp-manga&m_orderby=rating");
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(url).then(function (r) { return r.text(); })];
                    case 1:
                        body = _a.sent();
                        loadedCheerio = (0, cheerio_1.load)(body);
    ...
    LightNovelUpdates.prototype.fetchImage = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    return LightNovelUpdates;
}());
exports.default = new LightNovelUpdates();
