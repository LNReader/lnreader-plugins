...
var FreeWebNovel = /** @class */ (function () {
    ...
    FreeWebNovel.prototype.popularNovels = function (page, _a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var sort, body, loadedCheerio, novels;
            var _this = this;
                ...
                switch (_b.label) {
                    case 0:
                        sort = showLatestNovels
                            ...
                            : "/completed-novels/";
                        return [4 /*yield*/, (0, fetch_1.fetchApi)(this.site + sort + page).then(function (res) { return res.text(); })];
                    case 1:
                        body = _b.sent();
                        loadedCheerio = (0, cheerio_1.load)(body);
                        novels = loadedCheerio(".li-row")
                            .map(function (index, element) { return ({
                            name: loadedCheerio(element).find(".tit").text(),
                            cover: loadedCheerio(element).find("img").attr("src"),
                            url: _this.site + loadedCheerio(element).find("h3 > a").attr("href"),
                        }); })
                            .get();
    ...
    FreeWebNovel.prototype.parseNovelAndChapters = function (url) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    FreeWebNovel.prototype.parseChapter = function (chapterUrl) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        body = _a.sent();
                        loadedCheerio = (0, cheerio_1.load)(body);
                        novels = loadedCheerio(".li-row > .li > .con")
                            .map(function (index, element) { return ({
                            name: loadedCheerio(element).find(".tit").text(),
...
exports.default = new FreeWebNovel();
