(function () {
...
})()(
  {
    ...
    3: [
      ...
      { 'base64-js': 1, 'buffer': 3, 'ieee754': 30 },
    ],
    4: [
      function (require, module, exports) {
        'use strict';
    ...
    6: [
      ...
      { './foreignNames.js': 5, 'domelementtype': 7, 'entities': 25 },
    ],
    7: [
      function (require, module, exports) {
        'use strict';
    ...
    16: [
      ...
      { 'dom-serializer': 6, 'domelementtype': 7, 'domhandler': 8 },
    ],
    17: [
      function (require, module, exports) {
        'use strict';
    ...
    18: [
      ...
      },
      {
        ...
        './generated/decode-data-html.js': 22,
        './generated/decode-data-xml.js': 23,
      },
    ],
    19: [
      function (require, module, exports) {
    ...
    20: [
      ...
      { './escape.js': 21, './generated/encode-html.js': 24 },
    ],
    21: [
      function (require, module, exports) {
        'use strict';
    ...
    27: [
      ...
      { './Tokenizer.js': 28, 'entities/lib/decode.js': 18 },
    ],
    28: [
      function (require, module, exports) {
        'use strict';
    ...
    37: [
      ...
      { './comment': 36, './declaration': 39, './node': 47, './symbols': 58 },
    ],
    38: [
      function (require, module, exports) {
        'use strict';
      ...
      { './terminal-highlight': 2, 'picocolors': 34 },
    ],
    39: [
      function (require, module, exports) {
        'use strict';
          ...
          (function () {
            ...
            class LazyResult {
              ...
              visitTick(stack) {
                ...
                if (
                  visitors.length > 0 &&
                  visit.visitorIndex < visitors.length
                ) {
    ...
    45: [
      ...
      { './input': 42, 'buffer': 3, 'path': 2, 'source-map-js': 2, 'url': 2 },
    ],
    46: [
      function (require, module, exports) {
        (function (process) {
    ...
    48: [
      ...
      { './container': 37, './input': 42, './parser': 49, '_process': 62 },
    ],
    49: [
      function (require, module, exports) {
        'use strict';
